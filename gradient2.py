...
image_dimensionX = 1080
image_dimensionY = 1980

# initial brightness of the image
image_brightness = 50

# Color 1 for Gradient
color_one = [210, 150, 160]
...
def newImg():
    ...
    # image_brightness = 0.299 * color_one[0] + 0.587 * color_one[1] + 0.114 * color_one[2]

    temp = color_one
    brightness_increase_factor = (250 - image_brightness)/(image_dimensionX * image_change_range)
    ...
    while i < image_dimensionX:
        ...
        if switch and image_brightness < 250:
            ...
            switch = False
            # The Below Line is Responsible
            # color_one = color_two

        # The below line is responsible for Fade in then Out
